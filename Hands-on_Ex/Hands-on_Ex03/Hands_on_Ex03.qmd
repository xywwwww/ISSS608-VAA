...
# 3 Programming Interactive Data Visualization with R
...
## 3.4 Interactive Data Visulisation - ggiraph methods
...
-   Data_id: a column of data-sets that contain an id to be associated with elements. If it used within a shiny application, elements associated with an id (data_id) can be selected and manipulated on client and server sides. Refer to [this](https://davidgohel.github.io/ggiraph/articles/offcran/shiny.html) article for more detail explanation.
...
::: {.callout-note title="Interactivity"}
...
### 3.42 Displaying mnultiple information on tooltip
...
### 3.4.4 Displaying statistical on tool
...
![](image2.jpg) There are two ways to create interactive graph by using plotly, they are:
